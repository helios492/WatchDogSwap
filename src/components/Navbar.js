...
const Navbar = (props) => {
  ...
  function handleNetworkChange(e) {
    ...
    const selectedNetworkObj = networkList.find((network) => network.name === selectedNetwork);
  ...
  return (
    <div>
        <nav>
            ...
            <div>
                <ul id="navbar" className={isStateTrue ? "#navbar active" : "#navbar"}>
                    <li><Link to="/swap" className="link">
                    ...
                    <li>
                        <div className="connectButton" onClick={connect}>
                              {isConnected ? ensName ?? (address.slice(0,4) +"..." +address.slice(38)) : "Connect"}
                        </div>
                    </li>
                </ul>
            </div>
